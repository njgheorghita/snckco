...
Card.config = function (config) {
    ...
    config.minThrowOutDistance = config.minThrowOutDistance ? config.minThrowOutDistance : 1000;
    config.maxThrowOutDistance = config.maxThrowOutDistance ? config.maxThrowOutDistance : 1000;
...
Card.throwOutConfidence = function (offset, elementWidth) {
    return Math.min(Math.abs(offset) / 75, 1);
};
